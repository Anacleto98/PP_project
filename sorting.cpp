...
void BM_parallel_sort_32(benchmark::State& state) {
...
void BM_parallel_sort_64(benchmark::State& state) {
...
void BM_parallel_sort_128(benchmark::State& state) {
